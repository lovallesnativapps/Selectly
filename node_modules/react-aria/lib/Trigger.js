...
var Trigger = function (_Component) {
  ...
  function Trigger() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Trigger.__proto__ || Object.getPrototypeOf(Trigger)).call.apply(_ref, [this].concat(args))), _this), _this._isKeyDown = false, _this._handleKeyDown = function (e) {
      var _this$props = _this.props,
          keybindings = _this$props.keybindings,
  ...
  _createClass(Trigger, [{
    ...
    value: function _trigger(e) {
      ...
      if (this.context.overlayManager && typeof this.props.isOpen === 'undefined') {
    ...
    value: function _getProps() {
      ...
      var overlayManager = this.context.overlayManager;
      var _props = this.props,
          component = _props.component,
          disabled = _props.disabled,
          overlayRole = _props.overlayRole,
          controls = _props.controls,
          triggerOn = _props.triggerOn;

      var isOpen = overlayManager ? overlayManager.isOpen : this.props.isOpen;
      var props = (_props2 = {}, _defineProperty(_props2, component === 'button' ? 'type' : 'role', 'button'), _defineProperty(_props2, 'tabIndex', disabled ? '' : 0), _defineProperty(_props2, 'aria-disabled', disabled), _defineProperty(_props2, 'onKeyDown', this._handleKeyDown), _defineProperty(_props2, 'onKeyUp', this._handleKeyUp), _props2);
