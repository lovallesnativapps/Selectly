...
var Option = function (_Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      ...
      var _ref = select.activeDescendant || {},
          activeId = _ref.id;

      var itemProps = (0, _specialAssign2.default)({
        role: 'option',
        tabIndex: null }, this.props, checkedProps);

      return (0, _react.createElement)(_Items.Item, itemProps, function (_props) {
        var isHighlighted = _props.id === activeId;
        var props = _extends({}, _props, {
          'aria-selected': isHighlighted
        });

        if (typeof children === 'function') {
          return children({ props: props, isHighlighted: isHighlighted });
        }
