...
var ComboBox = function (_Component) {
  ...
  function ComboBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ComboBox.__proto__ || Object.getPrototypeOf(ComboBox)).call.apply(_ref, [this].concat(args))), _this), _this._setInput = function (input) {
      _this._input = input;
    }, _this._getInput = function () {
      return _this._input;
...
ComboBox.childContextTypes = {
  comboBox: _react.PropTypes.object
};
ComboBox.propTypes = checkedProps;
