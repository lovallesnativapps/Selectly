...
var Item = function (_Component) {
  ...
  function Item() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Item.__proto__ || Object.getPrototypeOf(Item)).call.apply(_ref, [this].concat(args))), _this), _this._id = _this.props.id || (0, _uuid2.default)(), _this._handleMemberFocus = function (member, e) {
      ...
      _this.context.itemCollection.onItemSelection(_this._member, e);
  ...
  _createClass(Item, [{
    ...
    value: function componentDidMount() {
      var members = this.context.itemCollection.members;
    ...
    value: function componentWillUnmount() {
      this.context.itemCollection.members.remove(this._member);
    }
  }, {
    key: 'render',
...
Item.contextTypes = {
  itemCollection: _react.PropTypes.object
};
